...
__copyright__ = "Copyright 2019, Udacity Full Stack Developer NanoDegree Project"
__version__ = "1.0.1"
...
def main():
    ...
    most_popular_articles = connect_exec_and_return(
    '''
        SELECT "title", COUNT(*) AS "nr_of_views"
    ...
    most_popular_author = connect_exec_and_return(
    '''
        SELECT c."name", COUNT(*) AS "nr_of_views"
    FROM 
